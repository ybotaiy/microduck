...
This is an independent personal repository for the agent layer. Keep it private. The ignored `microduck-lab/` tree contains separate external Git repositories; do not add their source or histories to this repository. Read their own applicable instructions before any authorized work inside them.

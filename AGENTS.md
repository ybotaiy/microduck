...
This is an independent personal repository for the agent layer. It may become public; do not add secrets, absolute local paths, or private personal details. The ignored `microduck-lab/` tree contains separate external Git repositories; do not add their source or histories to this repository. Read their own applicable instructions before any authorized work inside them.
